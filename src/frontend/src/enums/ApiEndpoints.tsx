...
export enum ApiEndpoints {
  ...
  user_simple_login = 'auth/email/generate/',
  ...
  currency_list = 'core/currency/exchange/',
  currency_refresh = 'core/currency/refresh/',
  all_units = 'units/all/',
  task_overview = 'admin/background-task/',
  task_pending_list = 'admin/background-task/pending/',
  task_scheduled_list = 'admin/background-task/scheduled/',
  task_failed_list = 'admin/background-task/failed/',
  api_search = 'search/',
  ...
  error_report_list = 'admin/error-report/',
