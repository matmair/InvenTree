# Generated by Django 5.2.15 on 2026-07-24 07:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.FileField(help_text='Report asset file', upload_to='report/assets', verbose_name='Asset')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('snippet', models.FileField(help_text='Report snippet file', upload_to='report/snippets', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['html', 'htm'])], verbose_name='Snippet')),
        ...
        migrations.AlterField(
            ...
            name='model_type',
            field=models.CharField(help_text='Target model type for template', max_length=100, validators=[report.validators.validate_report_model_type], verbose_name='Model Type'),
        ),
        migrations.AlterField(
            model_name='labeltemplate',
            name='template',
        ...
        migrations.AddField(
            model_name='reporttemplate',
            name='merge',
            field=models.BooleanField(default=False, help_text='Render a single report against selected items', verbose_name='Merge'),
        ),
        migrations.AddField(
            model_name='labeltemplate',
            name='updated',
