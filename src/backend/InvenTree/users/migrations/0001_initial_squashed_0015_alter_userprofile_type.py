# Generated by Django 5.2.15 on 2026-07-24 07:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('owner_type', 'owner_id'), name='unique_owner')],
            },
        ),
        migrations.CreateModel(
            name='RuleSet',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[(users.ruleset.RuleSetEnum['ADMIN'], 'Admin'), (users.ruleset.RuleSetEnum['PART_CATEGORY'], 'Part Categories'), (users.ruleset.RuleSetEnum['PART'], 'Parts'), (users.ruleset.RuleSetEnum['BOM'], 'Bills of Material'), (users.ruleset.RuleSetEnum['STOCK_LOCATION'], 'Stock Locations'), (users.ruleset.RuleSetEnum['STOCK'], 'Stock Items'), (users.ruleset.RuleSetEnum['BUILD'], 'Build Orders'), (users.ruleset.RuleSetEnum['PURCHASE_ORDER'], 'Purchase Orders'), (users.ruleset.RuleSetEnum['SALES_ORDER'], 'Sales Orders'), (users.ruleset.RuleSetEnum['RETURN_ORDER'], 'Return Orders'), (users.ruleset.RuleSetEnum['TRANSFER_ORDER'], 'Transfer Orders')], help_text='Permission set', max_length=50)),
        ...
        migrations.AlterField(
            model_name='ruleset',
            name='can_view',
            field=models.BooleanField(default=False, help_text='Permission to view items', verbose_name='View'),
        ),
        migrations.RunPython(migrations.RunPython.noop, reverse_code=migrations.RunPython.noop),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.AlterField(
            ...
            name='type',
            field=models.CharField(choices=[('bot', 'Bot'), ('internal', 'Internal'), ('external', 'External'), ('guest', 'Guest')], default='internal', help_text='Which type of user is this?', max_length=10, verbose_name='User Type'),
        ),
    ]
