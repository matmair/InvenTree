    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('bot', 'Bot'), ('internal', 'Internal'), ('external', 'External'), ('guest', 'Guest')], default='internal', help_text='Which type of user is this?', max_length=10, verbose_name='User Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[(users.ruleset.RuleSetEnum['ADMIN'], 'Admin'), (users.ruleset.RuleSetEnum['PART_CATEGORY'], 'Part Categories'), (users.ruleset.RuleSetEnum['PART'], 'Parts'), (users.ruleset.RuleSetEnum['STOCKTAKE'], 'Stocktake'), (users.ruleset.RuleSetEnum['STOCK_LOCATION'], 'Stock Locations'), (users.ruleset.RuleSetEnum['STOCK'], 'Stock Items'), (users.ruleset.RuleSetEnum['BUILD'], 'Build Orders'), (users.ruleset.RuleSetEnum['PURCHASE_ORDER'], 'Purchase Orders'), (users.ruleset.RuleSetEnum['SALES_ORDER'], 'Sales Orders'), (users.ruleset.RuleSetEnum['RETURN_ORDER'], 'Return Orders')], help_text='Permission set', max_length=50)),
