# Generated by Django 5.2.15 on 2026-07-24 07:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "columns",
                    models.JSONField(blank=True, null=True, verbose_name="Columns"),
                ),
                (
                    "model_type",
                    models.CharField(
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        null=True,
                        verbose_name="Completed Row Count History",
                    ),
                ),
                (
                    "row_count_history",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Row Count History"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "row_index",
                    models.PositiveIntegerField(default=0, verbose_name="Row Index"),
                ),
                (
                    "row_data",
                    models.JSONField(
                        blank=True, null=True, verbose_name="Original row data"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "column",
                    models.CharField(blank=True, max_length=100, verbose_name="Column"),
                ),
                (
                    "session",
                    models.ForeignKey(
