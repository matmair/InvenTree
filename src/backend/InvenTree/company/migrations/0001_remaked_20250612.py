    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_currency', djmoney.models.fields.CurrencyField(choices=[('AUD', 'AUD - Australian Dollar'), ('CAD', 'CAD - Canadian Dollar'), ('CNY', 'CNY - Chinese Yuan'), ('EUR', 'EUR - Euro'), ('GBP', 'GBP - British Pound'), ('JPY', 'JPY - Japanese Yen'), ('NZD', 'NZD - New Zealand Dollar'), ('USD', 'USD - US Dollar')], default='USD', editable=False, max_length=3, null=True)),
                ('price', InvenTree.fields.InvenTreeModelMoneyField(currency_choices=[('AUD', 'AUD - Australian Dollar'), ('CAD', 'CAD - Canadian Dollar'), ('CNY', 'CNY - Chinese Yuan'), ('EUR', 'EUR - Euro'), ('GBP', 'GBP - British Pound'), ('JPY', 'JPY - Japanese Yen'), ('NZD', 'NZD - New Zealand Dollar'), ('USD', 'USD - US Dollar')], decimal_places=6, default_currency='USD', help_text='Unit price at specified quantity', max_digits=19, null=True, validators=[djmoney.models.validators.MinMoneyValidator(0)], verbose_name='Price')),
