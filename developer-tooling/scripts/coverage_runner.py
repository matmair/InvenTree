"""Test coverage runner script for InvenTree database migrations."""
...
def run_tests_with_cov():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        migrate_res = subprocess.run(
            migrate_cmd, env=env, capture_output=True, text=True, check=False
        )
        ...
        print(
            f'Running tests with coverage analysis in isolated directory: {tmpdir}...'
        )
...
def main():
    """Main entry point for coverage verification runner."""
